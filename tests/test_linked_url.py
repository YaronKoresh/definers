...
class TestLinkedUrl(unittest.TestCase):
    ...
    def test_basic_url(self):
        ...
        self.assertIn('<base href="http://example.com" target="_top">', decoded_html)
        self.assertIn("<a href=\"\"></a>", decoded_html)
        self.assertIn("onload='document.querySelector(\"a\").click()'", decoded_html)
    ...
    def test_url_with_query_params(self):
        ...
        self.assertIn('<base href="https://example.com/path" target="_top">', decoded_html)
        self.assertIn('<a href="?param1=value1&param2=value2"></a>', decoded_html)
