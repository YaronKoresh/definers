...
sys.modules["PIL.Image"] = MagicMock(
    open=MagicMock(return_value=mock_image)
)
...
class TestAnswer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher_model = patch.dict(
            "definers.MODELS", {"answer": self.mock_model}
        )
        self.patcher_merge = patch(
            "definers.merge_system_message",
            return_value="<|system|>Mock System Message<|end|>\n",
        )
