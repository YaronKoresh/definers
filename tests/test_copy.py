...
class TestCopy(unittest.TestCase):
    ...
    @patch('shutil.copy')
    def test_copy_directory(self, mock_copy, mock_copytree, mock_is_symlink, mock_isdir):
    ...
    @patch('shutil.copytree')
    @patch('shutil.copy')
    def test_copy_symlinked_directory(self, mock_copy, mock_copytree, mock_path, mock_isdir):
    ...
    @patch('shutil.copytree')
    @patch('shutil.copy')
    def test_copy_file(self, mock_copy, mock_copytree, mock_path, mock_isdir):
    ...
    @patch('shutil.copytree')
    @patch('shutil.copy')
    def test_copy_symlinked_file(self, mock_copy, mock_copytree, mock_path, mock_isdir):
        mock_path_instance = MagicMock()
        mock_path.return_value = mock_path_instance
        mock_path_instance.is_symlink.return_value = True
