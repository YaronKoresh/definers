...
class TestExtractAudioFeatures(unittest.TestCase):
    ...
    def test_successful_extraction(self):
        ...
        mock_librosa.load.return_value = (self.dummy_audio_data, self.sample_rate)
    ...
    def test_custom_n_mfcc(self):
        ...
        self.assertIsNotNone(features)
        mock_librosa.feature.mfcc.assert_called_with(y=self.dummy_audio_data, sr=self.sample_rate, n_mfcc=n_mfcc, n_fft=2048, n_mels=80)
