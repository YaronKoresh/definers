...
class TestInstalled(unittest.TestCase):
    ...
    def test_installed_linux_command_exists_no_version(
        self, mock_which, mock_run, mock_os
    ):
    ...
    @patch("definers.run")
    @patch("definers.shutil.which")
    def test_installed_linux_command_version_match(
        self, mock_which, mock_run, mock_os
    ):
    ...
    @patch("definers.run")
    @patch("definers.shutil.which")
    def test_installed_linux_command_version_wildcard(
        self, mock_which, mock_run, mock_os
    ):
        mock_which.return_value = "/usr/bin/ffmpeg"
        mock_run.return_value = [
    ...
    @patch("definers.run")
    def test_installed_windows_program_exists_no_version(
