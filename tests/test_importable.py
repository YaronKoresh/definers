...
class TestImportable(unittest.TestCase):
    ...
    def test_importable_returns_false_for_failed_import(self, mock_run):
        ...
        mock_run.assert_called_once_with('python -c "import non_existent_package"', silent=True)
    ...
    def test_importable_with_complex_name(self, mock_run):
        ...
        mock_run.assert_called_once_with('python -c "import unittest.mock"', silent=True)
