...
class TestTmp(unittest.TestCase):
    ...
    def test_tmp_directory_no_keep(self, mock_delete, mock_tempdir):
        mock_tempdir.return_value.__enter__.return_value = '/tmp/test_dir_to_delete'
    ...
    def test_tmp_file_default_keep(self, mock_delete, mock_tempfile):
        mock_tempfile.return_value.__enter__.return_value.name = '/tmp/test_file.data'
        result = tmp()
    ...
    def test_tmp_file_no_keep(self, mock_delete, mock_tempfile):
        mock_tempfile.return_value.__enter__.return_value.name = '/tmp/test_file_to_delete.data'
    ...
    def test_tmp_file_custom_suffix_with_dot(self, mock_tempfile):
        mock_tempfile.return_value.__enter__.return_value.name = '/tmp/test_file.txt'
    ...
    def test_tmp_file_custom_suffix_without_dot(self, mock_tempfile):
        mock_tempfile.return_value.__enter__.return_value.name = '/tmp/test_file.log'
    ...
    def test_tmp_file_suffix_with_multiple_dots(self, mock_tempfile):
        mock_tempfile.return_value.__enter__.return_value.name = '/tmp/test_file.zip'
    ...
    def test_tmp_file_suffix_ending_with_dot(self, mock_tempfile):
        mock_tempfile.return_value.__enter__.return_value.name = '/tmp/test_file.tmp'
