...
Use `image-generate` when you want either a direct one-shot generation or a persistent staged job that can resume across generation, upscaling, and title overlay stages.
