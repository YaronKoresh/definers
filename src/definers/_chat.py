"""Chat and UI utilities for the definers package."""
    ...
    if not lines:
        ...
        try:
            ...
            processed_lines = [
                (
                    line,
                    [clean_word(w) for w in re.findall(r"\b[\w'-]+\b", line)],
                )
                for line in lines
            ]
            ...
            correct_words_flat = [
                word for _, line_words in processed_lines for word in line_words
            ]
